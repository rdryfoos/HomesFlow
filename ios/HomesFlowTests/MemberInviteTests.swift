...
final class MemberInviteTests: XCTestCase {
    ...
    func test_AC_USER_07_paste_token_accepts_invite() {
        ...
        XCTAssertEqual(
            InvitePolicy.extractToken(fromPastedText: "homesflow://invite?token=\(token)"),
            token,
        ...
        XCTAssertNil(InvitePolicy.extractToken(fromPastedText: "   "))
        XCTAssertNil(InvitePolicy.extractToken(fromPastedText: "homesflow://invite"))
        XCTAssertNil(InvitePolicy.extractToken(fromPastedText: "homesflow://invite?token="))
    }
}
